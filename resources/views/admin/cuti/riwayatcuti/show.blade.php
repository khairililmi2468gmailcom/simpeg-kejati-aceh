    ...
    <div class="space-y-12">
        <div class="border-b border-gray-900/10 pb-12">
            <div class="flex justify-between items-start">
                <div>
                    <h2 class="text-3xl font-semibold text-[#00A181]">Detail Riwayat Cuti</h2>
                    <p class="mt-1 text-sm text-gray-600">Informasi lengkap mengenai riwayat cuti pegawai.</p>
                </div>
            ...
            <div class="mt-10 space-y-12 text-gray-800 bg-white p-8 rounded-xl">
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-6 gap-x-6 gap-y-6">
                        <x-display label="No. Surat" class="sm:col-span-3">{{ $data->no_surat }}</x-display>
                        <x-display label="Nama Cuti" class="sm:col-span-3">{{ $data->cuti->jenis_cuti }}</x-display>
                        <x-display label="Nama Cuti" class="sm:col-span-3">{{ $data->jumlah_cuti }} Hari</x-display>
                        <x-display label="Keterangan" class="sm:col-span-3">{{ $data->keterangan }}</x-display>
