...
@section('content')
    <h1 class="text-3xl font-bold text-[#00A181]">Riwayat Kepangkatan</h1>
    <p class="text-gray-600">Halaman Kepangkatan</p>

    <div class="flex flex-wrap justify-between items-center mb-4 mt-4">
        <!-- Input Search -->
        <div class="w-full md:w-1/3 mb-4 md:mb-0 relative">
            <form action="{{ route('admin.kepangkatan.index') }}" method="GET">
        ...
        <div class="flex flex-wrap justify-end space-x-2">
            <a href="{{ route('admin.kepangkatan.create') }}"
                    ...
                    <tr class="hover:bg-gray-50 transition-all duration-150">
                        ...
                        <td class="px-5 py-4 space-y-2">
                            <a href="{{ route('admin.kepangkatan.show', $item->no_sk) }}"
                                class="cursor-pointer w-full sm:w-auto inline-flex justify-center items-center text-white bg-blue-500 hover:bg-blue-600 font-semibold rounded-md text-sm px-4 py-2">
                            ...
                            @if ($item->is_last)
                                <a href="{{ route('admin.kepangkatan.edit', $item->no_sk) }}"
                                ...
                                <form action="{{ route('admin.kepangkatan.destroy', $item->no_sk) }}" method="POST"
