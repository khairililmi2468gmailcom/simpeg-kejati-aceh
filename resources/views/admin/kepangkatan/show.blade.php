    ...
    <div class="space-y-12">
        <div class="border-b border-gray-900/10 pb-12">
            <div class="flex justify-between items-start">
                <div>
                    <h2 class="text-3xl font-semibold text-[#00A181]">Detail Riwayat Kepangkatan</h2>
                    <p class="mt-1 text-sm text-gray-600">Informasi lengkap mengenai riwayat kepangkatan pegawai.</p>
                </div>
            ...
            <div class="mt-10 space-y-12 text-gray-800 bg-white p-8 rounded-xl">
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-6 gap-x-6 gap-y-6">
                        ...
                        <x-display label="Jabatan Fungsional"
                            class="sm:col-span-3">{{ $data->pegawai->golongan->jabatan_fungsional ?? '-' }}</x-display>
