...
--
-- Host: localhost
-- Waktu pembuatan: 19 Mar 2025 pada 13.15
...
INSERT INTO `diklat` (`id_diklat`, `jenis_diklat`, `nama_diklat`) VALUES
(1, 'Diklat Teknis', 'Diklat Komputer 1'),
(2, 'Diklat Teknis', 'Diklat Komputer 2'),
(3, 'Diklat Fungsional', 'Diklat Intelejen'),
(4, 'Diklat Fungsional', 'Diklat Intelejen 2'),
(5, 'Diklat Fungsional', 'Diklat Manajemen'),
(6, 'Diklat Teknis', 'Diklat Pemerintahan 1'),
(7, 'Diklat Teknis', 'Diklat Pemerintahan 2'),
(8, 'Diklat Struktural', 'Diklat Eselon 1');
...
CREATE TABLE `golongan` (
  ...
  `jab_fungsional` varchar(25) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `golongan` (`golongan`, `pangkat`, `jab_fungsional`) VALUES
('I/a', 'Yuana Tama TU', 'NONJAKSA'),
('I/b', 'Muda Tama TU', 'NONJAKSA'),
('I/c', 'Madya Tama TU', 'NONJAKSA'),
('I/d', 'Sena Tama TU', 'NONJAKSA'),
('II/a', 'Yuana Darma TU', 'NONJAKSA'),
('II/b', 'Muda Darma TU', 'NONJAKSA'),
('II/c', 'Madya Darma TU', 'NONJAKSA'),
('II/d', 'Sena Darma TU', 'NONJAKSA'),
('III/a', 'Ajun Jaksa Madya', 'JAKSA'),
('III/b', 'Ajun Jaksa', 'JAKSA'),
('III/c', 'Jaksa Pratama', 'JAKSA'),
('III/d', 'Jaksa Muda', 'JAKSA'),
('IV/a', 'Jaksa Madya', 'JAKSA'),
('IV/b', 'Jaksa Utama Pratama', 'JAKSA'),
('IV/c', 'Jaksa Utama Muda', 'JAKSA'),
('IV/d', 'Jaksa Utama Madya', 'JAKSA');
...
INSERT INTO `jabatan` (`id_jabatan`, `jabatan`, `kode_kantor`, `ket`) VALUES
(37, 'Kepala Kejaksaan Tinggi Aceh', 1, 'KOSONG'),
(38, 'Wakil Kepala Kejaksaan Tinggi Aceh', 1, 'KOSONG'),
(40, 'Kepala Kejaksaan Negeri Banda Aceh', 2, 'KOSONG'),
(41, 'Kepala Kejaksaan Negeri Sabang', 3, 'KOSONG'),
(42, 'Kepala Kejaksaan Negeri Jantho', 4, 'KOSONG'),
(43, 'Kepala Kejaksaan Negeri Sigli', 5, 'KOSONG'),
(44, 'Kepala Kejaksaan Negeri Bireun', 6, 'KOSONG'),
(45, 'Kepala Kejaksaan Negeri Takengon', 7, 'KOSONG'),
(46, 'Kepala Kejaksaan Negeri Lhokseumawe', 8, 'KOSONG'),
(47, 'Kepala Kejaksaan Negeri Lhoksukon', 9, 'KOSONG'),
(48, 'Kepala Kejaksaan Negeri IDI', 10, 'KOSONG'),
(49, 'Kepala Kejaksaan Negeri Langsa', 11, 'KOSONG'),
(50, 'Kepala Kejaksaan Negeri Binjai', 26, 'KOSONG'),
(51, 'Kepala Kejaksaan Negeri P.Siantar', 26, 'KOSONG'),
(52, 'Kepala Kejaksaan Negeri Padang', 27, 'KOSONG'),
(53, 'Kepala Kasubbag Kepegawaian', 26, 'KOSONG'),
(54, 'Kepala Sub Bagian Persuratan', 1, 'KOSONG');
...
CREATE TABLE `kepangkatan` (
  ...
  `no_pertimbangan` varchar(100) DEFAULT NULL,
  `tgl_sk` date DEFAULT NULL,
  `pembuat_sk` varchar(50) DEFAULT NULL,
  `tmt_pangkat` date DEFAULT NULL,
  `no_usulan` varchar(50) DEFAULT NULL,
  `jenis_usulan` varchar(25) NOT NULL,
  `golongan` varchar(5) NOT NULL,
  `pangkat_l` varchar(25) NOT NULL,
...
INSERT INTO `login` (`username`, `password`, `foto`, `level`) VALUES
('admin', 'c93ccd78b2076528346216b3b2f701e6', 'admin.png', 'Admin');
...
CREATE TABLE `menerima_cuti` (
  ...
  `jumlah_cuti` varchar(255) NOT NULL,
...
CREATE TABLE `mengikuti_diklat` (
  `tempat_diklat` text DEFAULT NULL,
  `penyelenggara` text DEFAULT NULL,
  `angkatan` varchar(12) DEFAULT NULL,
  `tgl_mulai` date DEFAULT NULL,
  `tgl_selesai` date DEFAULT NULL,
  `jumlah_jam` int(4) DEFAULT NULL,
  `no_sttpp` varchar(25) NOT NULL,
  `tgl_sttpp` date DEFAULT NULL,
  `nip` varchar(18) DEFAULT NULL,
  `id_diklat` int(4) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `unit_kerja` (`kode_kantor`, `nama_kantor`, `provinsi`) VALUES
(1, 'Kejaksaan Tinggi Aceh', 'ACEH'),
(2, 'Kejaksaan Negeri Banda Aceh', 'ACEH'),
(3, 'Kejaksaan Negeri Sabang', 'ACEH'),
(4, 'Kejaksaan Negeri Jantho', 'ACEH'),
(5, 'Kejaksaan Negeri Sigli', 'ACEH'),
(6, 'Kejaksaan Negeri Bireun', 'ACEH'),
(7, 'Kejaksaan Negeri Takengon', 'ACEH'),
(8, 'Kejaksaan Negeri Lhokseumawe', 'ACEH'),
(9, 'Kejaksaan Negeri Lhoksukon', 'ACEH'),
(10, 'Kejaksaan Negeri Idi', 'ACEH'),
(11, 'Kejaksaan Negeri Langsa', 'ACEH'),
(12, 'Kejaksaan Negeri Kualasimpang', 'ACEH'),
(13, 'Kejaksaan Negeri Kutacane', 'ACEH'),
(14, 'Kejaksaan Negeri Blangkejeren', 'ACEH'),
(15, 'Kejaksaan Negeri Singkil', 'ACEH'),
(16, 'Kejaksaan Negeri Sinabang', 'ACEH'),
(17, 'Kejaksaan Negeri Tapaktuan', 'ACEH'),
(18, 'Kejaksaan Negeri Meulaboh', 'ACEH'),
(19, 'Kejaksaan Negeri Calang', 'ACEH'),
(20, 'Kejaksaan Negeri Sukamakmue', 'ACEH'),
(21, 'Kejaksaan Negeri Blangpidie', 'ACEH'),
(22, 'Kejaksaan Negeri SP Tiga Redelong', 'ACEH'),
(23, 'Kejaksaan Negeri Meuredu', 'ACEH'),
(24, 'Cabjari Kotabakti', 'ACEH'),
(25, 'Cabjari Bakongan', 'ACEH'),
(26, 'Kejaksaan Wilayah Sumatera Utara', 'LuarDaerah'),
(27, 'Kejaksaan Wilayah Sumatera Barat', 'LuarDaerah');
...
ALTER TABLE `jabatan`
  ...
  ADD KEY `kode_kantor` (`kode_kantor`);
...
--
ALTER TABLE `diklat`
  MODIFY `id_diklat` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT untuk tabel `jabatan`
--
ALTER TABLE `jabatan`
  MODIFY `id_jabatan` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=56;

--
-- AUTO_INCREMENT untuk tabel `unit_kerja`
--
ALTER TABLE `unit_kerja`
  MODIFY `kode_kantor` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;
...
--
ALTER TABLE `jabatan`
  ADD CONSTRAINT `jabatan_ibfk_1` FOREIGN KEY (`kode_kantor`) REFERENCES `unit_kerja` (`kode_kantor`);
...
--
ALTER TABLE `kepangkatan`
  ADD CONSTRAINT `kepangkatan_ibfk_1` FOREIGN KEY (`golongan`) REFERENCES `golongan` (`golongan`),
  ADD CONSTRAINT `kepangkatan_ibfk_2` FOREIGN KEY (`nip`) REFERENCES `pegawai` (`nip`);

--
-- Ketidakleluasaan untuk tabel `menerima_cuti`
--
ALTER TABLE `menerima_cuti`
  ADD CONSTRAINT `menerima_cuti_ibfk_1` FOREIGN KEY (`id_cuti`) REFERENCES `cuti` (`id_cuti`),
  ADD CONSTRAINT `menerima_cuti_ibfk_2` FOREIGN KEY (`nip`) REFERENCES `pegawai` (`nip`);

--
-- Ketidakleluasaan untuk tabel `mengikuti_diklat`
--
ALTER TABLE `mengikuti_diklat`
  ADD CONSTRAINT `mengikuti_diklat_ibfk_1` FOREIGN KEY (`id_diklat`) REFERENCES `diklat` (`id_diklat`),
  ADD CONSTRAINT `mengikuti_diklat_ibfk_2` FOREIGN KEY (`nip`) REFERENCES `pegawai` (`nip`);

--
-- Ketidakleluasaan untuk tabel `mutasi`
--
ALTER TABLE `mutasi`
  ADD CONSTRAINT `mutasi_ibfk_1` FOREIGN KEY (`id_jabatan`) REFERENCES `jabatan` (`id_jabatan`),
  ADD CONSTRAINT `mutasi_ibfk_2` FOREIGN KEY (`nip`) REFERENCES `pegawai` (`nip`);

--
-- Ketidakleluasaan untuk tabel `pegawai`
--
ALTER TABLE `pegawai`
  ADD CONSTRAINT `pegawai_ibfk_1` FOREIGN KEY (`id_gol`) REFERENCES `golongan` (`golongan`),
  ADD CONSTRAINT `pegawai_ibfk_2` FOREIGN KEY (`id_kantor`) REFERENCES `unit_kerja` (`kode_kantor`),
  ADD CONSTRAINT `pegawai_ibfk_3` FOREIGN KEY (`id_jabatan`) REFERENCES `jabatan` (`id_jabatan`),
  ADD CONSTRAINT `pegawai_ibfk_4` FOREIGN KEY (`provinsi`) REFERENCES `provinsi` (`id`),
  ADD CONSTRAINT `pegawai_ibfk_5` FOREIGN KEY (`kabupaten`) REFERENCES `kabupaten` (`id`),
  ADD CONSTRAINT `pegawai_ibfk_6` FOREIGN KEY (`kecamatan`) REFERENCES `kecamatan` (`id`);

--
-- Ketidakleluasaan untuk tabel `user`
--
ALTER TABLE `user`
  ADD CONSTRAINT `user_ibfk_1` FOREIGN KEY (`username`) REFERENCES `pegawai` (`nip`);
COMMIT;
